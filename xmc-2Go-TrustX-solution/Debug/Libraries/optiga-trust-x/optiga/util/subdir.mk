...
C_SRCS += \
../Libraries/optiga-trust-x/optiga/util/optiga_util.c 

OBJS += \
./Libraries/optiga-trust-x/optiga/util/optiga_util.o 

C_DEPS += \
./Libraries/optiga-trust-x/optiga/util/optiga_util.d 


# Each subdirectory must supply rules for building sources it contributes
Libraries/optiga-trust-x/optiga/util/%.o: ../Libraries/optiga-trust-x/optiga/util/%.c
	@echo 'Building file: $<'
